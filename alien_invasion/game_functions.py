...
def chack_event(ai_settings, screen, stats, play_button, ship_1, aliens, bullets):
...
# esa posicion la usamos para saber si coincide con la posicion del boton, ya que si coincide es como si se lo estuviera apretando.            
            check_play_button(ai_settings, screen, stats, play_button, ship_1, aliens, bullets, mouse_x, mouse_y)
